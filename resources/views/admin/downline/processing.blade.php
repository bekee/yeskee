...
@section('title')
	Processing Downlines
@stop

@section('heading')
	<div class="page-heading">
		<h3><i class='icon icon-compass-2'></i>Processing Downlines</h3>
	</div>
@stop
...
@section('heading')
	<div class="page-heading">
		<h1><i class='fa fa-arrows-alt'></i> Processing Downlines</h1>
	</div>
@stop
		...
		<div class="col-md-12 portlets">
			<div class="widget">
				...
				<div class="widget-content padding">
					<h5 class="text-center">You do not have any user on the processing stage</h5>
				</div>
			</div>
		</div>
	@endunless
		...
		<div class="col-md-12 portlets">
			<div class="widget">
				<div class="widget-header">
					<h2>Processing Downlines
						<small>Two Legs Incomplete</small>
					</h2>
										...
										<table data-sortable class="table table-hover table-striped">
											...
											<tr>
												@if($downlines->isEmpty())
													<td colspan="10"><p class="text-center">You do not have any user on
															the processing stage</p></td>
												@endif
											</tr>
