		...
		<div class="col-md-12 portlets">
			<div class="widget">
				<div class="widget-header">
					<h2>Edit {{\Illuminate\Support\Str::ucfirst($card->network)}} Recharge Cards </h2>
				...
				<div class="widget-content padding">
					...
					{!! Form::model($card,array('method'=>'PATCH','url' => ['admin/recharge_card',$card->id],'role'=>'form')) !!}
					...
					<div class="form-group">
						<label for="name">Used</label>
						{!! Form::checkbox('used',null,$card->used?true:false,['class'=>'form-control','id'=>'used'])  !!}
						@if ($errors->has('used'))
							<span class="help-inline">
                        <strong>{{ $errors->first('active') }}</strong>
                    </span>
