...
@section('heading')
	<div class="page-heading">
		<h1><i class='icon icon-window'></i> Pending Bonuses</h1>
	</div>
@stop
...
@section('heading')
	<div class="page-heading">
		<h1><i class='fa fa-arrows-alt'></i> All Pending Bonuses</h1>
	</div>
@stop
							...
							<div class="widget-content">
								<div class="table-responsive">
									<table data-sortable class="table table-hover table-striped">
										...
										@if($bonuses->isEmpty())
											<tr>
												<td colspan="11"><p class="text-center">THere is currently no bonus for
														any client</p></td>
											</tr>
										@endif
