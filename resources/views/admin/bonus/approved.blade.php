...
@section('heading')
	<div class="page-heading">
		<h1><i class='icon icon-window'></i> Approved Bonuses</h1>
	</div>
@stop
...
@section('heading')
	<div class="page-heading">
		<h1><i class='fa fa-arrows-alt'></i> All Approved Bonuses</h1>
	</div>
@stop
							...
							<div class="widget-content">
								<div class="table-responsive">
									<table data-sortable class="table table-hover table-striped">
										...
										@if($bonuses->isEmpty())
											<tr>
												<td colspan="11"><p class="text-center">There is currently no approved
