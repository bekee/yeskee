...
@section('heading_right')
	<a href="{{url(Auth::user()->route.'/r_level/'.$level)}}" class="btn btn-danger">DELETE</a>
@stop
@section('row1')
	<div class="col-lg-6">
		<div class="col-md-12 portlets">
			<div class="widget">
				...
				<div class="widget-content padding">
					...
					{!! Form::model($level,array('method'=>'PATCH','url' => ['admin/level',$level->id],'role'=>'form')) !!}
					...
					<div class="form-group">
						...
						<div class="input-groupw">
							...
							{!! Form::checkbox('active',null,$level->active==1?true:false,['class'=>'form-control','id'=>'active'])  !!}
						...
						<div class="row">
							<div class="col-lg-1">
								...
								<div class="input-group2">
									{!! Form::checkbox('discounted',null,$level->discounted==1?true:false,['class'=>'form-control','id'=>'discounted'])  !!}
					...
					<div class="form-group">
						<div class="row">
							<div class="col-lg-2">
								...
								<div class="input-group1">
									{!! Form::checkbox('referral',null,$level->referral==1?true:false,['class'=>'form-control','id'=>'referral'])  !!}
