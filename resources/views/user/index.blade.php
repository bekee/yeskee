		...
		<div class="widget">
			...
			<div class="widget-content padding">
				@unless(count($transactions))
					<h4 class="text-center">No Level Created YET <a href="{{url('dashboard/new_level')}}"
					                                                class="btn btn-success"> CHOOSE A LEVEL <span
									class="fa fa-arrow-circle-o-right"></span></a></h4>
				@endunless
...
@section('row2')
	<div class="col-md-12 portlets">
		<div class="widget">
			<div class="widget-header transparent">
				<h2><strong>LEVEL</strong> NAME</h2>
				<div class="additional-btn">
					<a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
					<a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
					<a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
			...
			<div class="widget-content padding">
				<h4>PAYOUT</h4>
				<div>EXPECTED:<span> @format(500, 4)</span></div>
				<div>EXPECTED:</div>
			</div>
			<div class="widget-content padding">
				<div class="text-center">
					<div class="yeskee">Y</div>
					<div class="yeskee">E</div>
					<div class="yeskee">S</div>
					<div class="yeskee">K</div>
					<div class="yeskee">E</div>
					<div class="yeskee">E</div>
				</div>
			</div>
