						...
						<ul class="nav navbar-nav navbar-right top-navbar">
							...
							<li class="dropdown topbar-profile">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<strong>{{Auth::user()->admin->last_name}}</strong>
						...
						<ul>
							<li class='has_sub'>
								...
								<ul>
									<li>
										<a href='{{url('admin')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin' ? 'active' : ''}}">
											<span>Home</span>
										</a>
									</li>
							...
							<li class='has_sub'>
								...
								<ul>
									<li>
										<a href='{{url('admin/unapproved_clients')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/unapproved_clients' ? 'active' : ''}}">
							...
							<li class='has_sub'>
								...
								<ul>
									<li>
										<a href='{{url('admin/unassigned')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/unassigned' ? 'active' : ''}}">
											<span>Unassigned DownLine</span>
										</a>
									</li>
									<li>
							...
							<li class='has_sub'>
								...
								<ul>
									<li>
										<a href='{{url('admin/issue_tracker')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/issue_tracker' ? 'active' : ''}}">
											<span>Issue Tracker</span>
										</a>
									</li>
							...
							<li class='has_sub'>
								...
								<ul>
									...
									<li>
										<a href='{{url('admin/approved_payment')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/approved_payment' ? 'active' : ''}}">
							...
							<li class='has_sub'>
								...
								<ul>
									<li>
										<a href='{{url('admin/withdrawal_pending')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/withdrawal_pending' ? 'active' : ''}}">
											<span>Pending Withdrawal</span>
										</a>
									</li>
									<li>
										<a href='{{url('admin/withdrawal_approved')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/withdrawal_approved' ? 'active' : ''}}">
											<span>Approved</span>
										</a>
									</li>
									<li>
										<a href='{{url('admin/withdrawal_cancelled')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/withdrawal_cancelled' ? 'active' : ''}}">
											<span>Cancelled</span>
										</a>
									</li>
								...
								<ul>
									<li>
										<a href='{{url('admin/agents')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/agents' ? 'active' : ''}}">
											<span>Agents</span>
										</a>
									</li>
								...
								<ul>
									...
									<li>
										<a href='{{url('admin/levels')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/levels' ? 'active' : ''}}">
											<span>Levels</span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href='{{url('admin/recharge_cards')}}'
										   class="{{Route::getCurrentRoute()->getPath() == 'admin/recharge_cards' ? 'active' : ''}}">
